...
- **Status:** **Aceito, NO AR e E2E do Owner VALIDADO (2026-09-04).** Owner aprovou a migração do
  ...
  E2E validado pelo Owner na loja Demo ("tudo testado e validado com sucesso"). Commits `21edc34` +
  `2e4217f` em `main` (push do Owner pendente).
- **Data:** 2026-09-04
