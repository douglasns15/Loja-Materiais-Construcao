...
| [ADR-025](./ADR-025-catalogo-global-ean.md) | Catálogo global de EAN (enriquecimento por código de barras e NF-e; cache cross-tenant custo-zero) | Aceito — Fatia 1 implementada (aguardando deploy + E2E) |
