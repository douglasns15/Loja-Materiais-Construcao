...
| [ADR-026](./ADR-026-divida-do-cliente-como-entidade.md) | Dívida do cliente como entidade (conta-corrente com código `D-0001`; 1 dívida aberta por cliente; supera a decisão 1 da ADR-022) | Proposto — modelo aprovado; migration `0030` aguarda aprovação |
