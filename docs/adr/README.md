...
| [ADR-029](./ADR-029-central-de-pendencias-computada.md) | Central de pendências computada (sino de alertas de cadastro/estoque/financeiro calculados sob demanda; sem push, sem tabela, sem migração; nasce visível a todos, role-scoping depois) | Proposto — detalhado no [plano da Central de Alertas](../plano-central-de-alertas.md) |
